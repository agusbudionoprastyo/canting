        ...
        <div class="container">
            ...
            <div v-if="categories.length > 0" class="flex flex-wrap gap-3 w-full mb-5 veg-navs">
                <button
                    ...
                    <i
                        class="lab-close-circle-line text-xl text-primary-500 transition opacity-0 -ml-8 clear-item-type-filter font-fill-primary lab-font-size-24"></i>
                </button>
                <button
                    ...
                    <i
                        class="lab-close-circle-line text-xl text-primary-500 transition opacity-0 -ml-8 font-fill-primary lab-font-size-24"></i>
                </button>
            </div>
